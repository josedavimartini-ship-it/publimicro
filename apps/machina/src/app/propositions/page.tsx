...
export const metadata: Metadata = {
  title: 'PubliMachina · Value Propositions',
  description: 'Value propositions and offers mapped to core segments and use cases.',
  keywords: ['machinery', 'agro', 'construction', 'OEM', 'industrial']
};

export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-3xl font-semibold">PubliMachina — Value Propositions</h1>
      ...
      <section className="mt-10 space-y-6">
        ...
        <div>
          ...
          <p>We’re integrating editorial content, dashboards, and case studies for PubliMachina.
