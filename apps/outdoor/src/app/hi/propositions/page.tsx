...
export const metadata: Metadata = {
  title: 'PubliOutdoor · Value Propositions',
  description: "Value propositions and offers mapped to segments and use cases.",
  keywords: ['OOH/DOOH','PubliOutdoor','trends','strategy','insights','hi']
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12" dir="ltr">
      <header>
        <h1 className="text-3xl font-semibold">PubliOutdoor — Value Propositions</h1>
