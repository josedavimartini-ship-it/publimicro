...
export const metadata: Metadata = {
  title: 'PubliCoisas · Visão Geral Executiva',
  description: "Panorama executivo com posicionamento, audiência e KPIs de curto prazo.",
  keywords: ['IoT & Dispositivos','PubliCoisas','trends','strategy','insights','pt']
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12" dir="ltr">
      <header>
        <h1 className="text-3xl font-semibold">PubliCoisas — Visão Geral Executiva</h1>
      ...
      <section className="mt-12">
        ...
        <article className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
          <h3 className="text-lg font-medium">PubliCoisas - Propostas de Valor</h3>
        ...
        <article className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
          <h3 className="text-lg font-medium">PubliCoisas - Mercado e Tendências</h3>
