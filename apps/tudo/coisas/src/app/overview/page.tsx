...
export const metadata: Metadata = {
  title: 'PubliCoisas · Executive Overview',
  description: 'Executive overview covering positioning, audience, and near‑term KPIs.',
  keywords: ['IoT', 'devices', 'connected', 'edge', 'sensors']
};

export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-3xl font-semibold">PubliCoisas — Executive Overview</h1>
      ...
      <section className="mt-10 space-y-6">
        ...
        <div>
          ...
          <p>We’re integrating editorial content, dashboards, and case studies for PubliCoisas.
