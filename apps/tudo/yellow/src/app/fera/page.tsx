...
export const metadata: Metadata = {
  ...
  description: 'Fera: a bold, creative corner for experiments, drops, and playful prototypes.',
  keywords: ['yellow', 'fera', 'creative', 'labs', 'drops']
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="text-zinc-600 mt-2">Fera: a bold, creative corner for experiments, drops, and playful prototypes.</p>
      ...
      <section className="mt-10 space-y-6">
        ...
        <div>
          ...
          <p>We’re integrating editorial content, dashboards, and case studies for PubliYellow.
