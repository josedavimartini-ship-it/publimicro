...
export const metadata: Metadata = {
  title: 'PubliYellow · Value Propositions',
  description: 'Value propositions and offers mapped to core segments and use cases.',
  keywords: ['youth', 'trends', 'culture', 'creative', 'community']
};

export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-3xl font-semibold">PubliYellow — Value Propositions</h1>
