...
export const metadata: Metadata = {
  title: 'PubliJourney · Visão Geral Executiva',
  description: "Panorama executivo com posicionamento, audiência e KPIs de curto prazo.",
  keywords: ['Viagens','PubliJourney','trends','strategy','insights','pt']
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12" dir="ltr">
      <header>
        <h1 className="text-3xl font-semibold">PubliJourney — Visão Geral Executiva</h1>
      ...
      <section className="mt-12">
        ...
        <article className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
          <h3 className="text-lg font-medium">PubliJourney - Propostas de Valor</h3>
        ...
        <article className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
          <h3 className="text-lg font-medium">PubliJourney - Mercado e Tendências</h3>
        ...
        <article className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
          <h3 className="text-lg font-medium">PubliJourney - Casos de Uso</h3>
