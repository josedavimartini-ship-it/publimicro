...
export const metadata: Metadata = {
  title: 'PubliJourney · Value Propositions',
  description: 'Value propositions and offers mapped to core segments and use cases.',
  keywords: ['travel', 'tourism', 'hospitality', 'mobility', 'booking']
};

export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-3xl font-semibold">PubliJourney — Value Propositions</h1>
      ...
      <section className="mt-10 space-y-6">
        ...
        <div>
          ...
          <p>We’re integrating editorial content, dashboards, and case studies for PubliJourney.
