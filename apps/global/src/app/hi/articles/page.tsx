...
export const metadata: Metadata = {
  title: 'PubliGlobal · Articles & Insights',
  description: "Original articles, analysis and research by the editorial team.",
  keywords: ['Global','PubliGlobal','trends','strategy','insights','hi']
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12" dir="ltr">
      <header>
        <h1 className="text-3xl font-semibold">PubliGlobal — Articles & Insights</h1>
