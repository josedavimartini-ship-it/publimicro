...
export const metadata: Metadata = {
  title: 'PubliGlobal · Artículos e Insights',
  description: "Artículos originales, análisis e investigación del equipo editorial.",
  keywords: ['Global','PubliGlobal','trends','strategy','insights','es']
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12" dir="ltr">
      <header>
        <h1 className="text-3xl font-semibold">PubliGlobal — Artículos e Insights</h1>
      ...
      <section className="mt-12">
        ...
        <article className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
          <h3 className="text-lg font-medium">PubliGlobal - Propuestas de Valor</h3>
        ...
        <article className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
          <h3 className="text-lg font-medium">PubliGlobal - Mercado y Tendencias</h3>
