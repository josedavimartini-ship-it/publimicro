...
export const metadata: Metadata = {
  title: "Proper Rural � Fazendas, S�tios e Propriedades Rurais",
  description: "Fazendas, s�tios, ch�caras e propriedades rurais em todo o Brasil. Produ��o, lazer e investimento.",
}

const propertyTypes = [
  { value: "fazenda", label: "Fazendas", icon: "??", count: "320+", desc: "Produ��o e pecu�ria" },
  { value: "sitio", label: "S�tios", icon: "??", count: "450+", desc: "Lazer e moradia" },
  { value: "chacara", label: "Ch�caras", icon: "??", count: "280+", desc: "Fim de semana" },
  { value: "terreno", label: "Terrenos", icon: "??", count: "190+", desc: "Investimento" },
]

const regions = [
  { name: "Tri�ngulo Mineiro", state: "MG", properties: "85+" },
  { name: "Sul de Minas", state: "MG", properties: "120+" },
  { name: "Interior de SP", state: "SP", properties: "200+" },
  { name: "Norte do Paran�", state: "PR", properties: "65+" },
  { name: "Centro-Oeste", state: "GO/MT/MS", properties: "140+" },
  { name: "Vale do Para�ba", state: "SP/RJ", properties: "75+" },
]
    ...
    <main className="min-h-screen flex flex-col bg-[#0f0f0f]">
      ...
      <section className="px-6 py-16 text-center bg-gradient-to-b from-[#0b0b0b] to-[#0f0f0f]">
        ...
        <p className="text-[#bfa97a] max-w-2xl mx-auto text-lg">
          Fazendas, s�tios, ch�caras e propriedades rurais. 
          Do agroneg�cio ao ref�gio de fim de semana.
        </p>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div>
              ...
              <div className="text-xs text-[#bfa97a]">Em Negocia��o</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#cfa847] mb-1">95%</div>
              <div className="text-xs text-[#bfa97a]">Satisfa��o</div>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="producao">Produ��o/Agroneg�cio</option>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {[
            { name: "Fazenda S�o Francisco", area: "850 ha", location: "Uberaba, MG", price: "R$ 15.000.000" },
            { name: "S�tio Recanto Verde", area: "42 ha", location: "Socorro, SP", price: "R$ 1.850.000" },
      ...
      <section className="px-6 py-16 text-center bg-gradient-to-t from-[#0b0b0b] to-[#0f0f0f]">
        ...
        <p className="text-[#bfa97a] mb-8 max-w-2xl mx-auto">
          Anuncie gratuitamente e conecte-se com compradores qualificados e investidores do agroneg�cio.
        </p>
        <Link
          href="/post"
      ...
      <footer className="border-t border-[#2a2a1a] bg-[#0a0a0a] px-6 py-8 mt-16">
        <div className="max-w-7xl mx-auto text-center text-sm text-[#676767]">
          <p>© {new Date().getFullYear()} AcheMeRuralPropers. All rights reserved.</p>
        </div>
      </footer>
    </main>
  )
