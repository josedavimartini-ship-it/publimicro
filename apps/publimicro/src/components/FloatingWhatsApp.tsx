  ...
  return (
    <>
      ...
      >
        ...
        {/* Text - shows on hover on desktop */}
        <span className="hidden md:group-hover:inline-block font-bold whitespace-nowrap">
          Fale Conosco
        </span>
      ...
      {/* Mobile-optimized version - shows text always on mobile */}
      <style jsx global>{`
