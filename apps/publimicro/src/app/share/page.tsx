  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#0a0a0a] via-[#0d0d0d] to-[#0a0a0a] py-20 px-6 mr-64">
      <div className="max-w-7xl mx-auto text-center">
        <h1 className={"text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#5F7161] to-[#6C8C5E] mb-6".replace("#5F7161","#5F7161").replace("#6C8C5E","#6C8C5E")}>
           PubliShare
        </h1>
        <p className="text-2xl text-[#d8c68e] mb-8">Economia Colaborativa</p>
