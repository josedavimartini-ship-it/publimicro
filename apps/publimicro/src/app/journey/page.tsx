  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#0a0a0a] via-[#0d0d0d] to-[#0a0a0a] py-20 px-6 mr-64">
      <div className="max-w-7xl mx-auto text-center">
        <h1 className={"text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#B7791F] to-[#FF6B35] mb-6".replace("#B7791F","#B7791F").replace("#FF6B35","#FF6B35")}>
           PubliJourney
        </h1>
        ...
        <Link href="/" className="inline-block mt-8 px-8 py-4 bg-gradient-to-r from-[#B7791F] to-[#FF6B35] text-[#0a0a0a] font-bold rounded-full hover:scale-105 transition-all">
           Voltar ao Início
        </Link>
      </div>
    </main>
