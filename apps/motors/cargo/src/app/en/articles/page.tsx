...
export const metadata: Metadata = {
  title: 'PubliCargo · Articles & Insights',
  description: "Original articles, analysis and research by the editorial team.",
  keywords: ['Logística','PubliCargo','trends','strategy','insights','en']
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12" dir="ltr">
      <header>
        <h1 className="text-3xl font-semibold">PubliCargo — Articles & Insights</h1>
