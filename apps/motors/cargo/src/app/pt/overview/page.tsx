...
export const metadata: Metadata = {
  title: 'PubliCargo · Visão Geral Executiva',
  description: "Panorama executivo com posicionamento, audiência e KPIs de curto prazo.",
  keywords: ['Logística','PubliCargo','trends','strategy','insights','pt']
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12" dir="ltr">
      <header>
        <h1 className="text-3xl font-semibold">PubliCargo — Visão Geral Executiva</h1>
      ...
      <section className="mt-12">
        ...
        <article className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
          <h3 className="text-lg font-medium">PubliCargo - Propostas de Valor</h3>
        ...
        <article className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
          <h3 className="text-lg font-medium">PubliCargo - Mercado e Tendências</h3>
