...
export const metadata: Metadata = {
  title: 'PubliMotos · Executive Overview',
  description: "Executive panorama covering positioning, audience and near-term KPIs.",
  keywords: ['Duas Rodas','PubliMotos','trends','strategy','insights','zh']
};
...
export default function Page() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12" dir="ltr">
      <header>
        <h1 className="text-3xl font-semibold">PubliMotos — Executive Overview</h1>
