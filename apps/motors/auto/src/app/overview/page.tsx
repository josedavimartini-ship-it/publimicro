...
export const metadata: Metadata = {
  title: 'PubliAutos · Executive Overview',
  description: 'Executive overview covering positioning, audience, and near‑term KPIs.',
  keywords: ['automotive', 'cars', 'EV', 'mobility', 'dealers']
};

export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-3xl font-semibold">PubliAutos — Executive Overview</h1>
      ...
      <section className="mt-10 space-y-6">
        ...
        <div>
          ...
          <p>We’re integrating editorial content, dashboards, and case studies for PubliAutos.
